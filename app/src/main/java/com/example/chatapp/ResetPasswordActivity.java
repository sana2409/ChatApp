...
public class ResetPasswordActivity extends AppCompatActivity { MaterialEditText send_email;
    Button btn_reset;
                    ...
                    Toast.makeText(ResetPasswordActivity.this, "All fields are required",Toast.LENGTH_SHORT).show();
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                                ...
                                startActivity(new Intent(ResetPasswordActivity.this, LoginActivity.class)); } else {
